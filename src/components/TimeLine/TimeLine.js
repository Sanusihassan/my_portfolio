...
const Timeline = () => {
  ...
  return (
    <Section id="about">
      ...
      <SectionText>
        {/* I am a Web Developer with over half a decade of experience in web
        development. I specialize in helping companies entrepreneurs & start-ups
        build their web applications. */}
